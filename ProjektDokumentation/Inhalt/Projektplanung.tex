...
\label 
In der Projektplanung soll die notwendige Zeit und die benötigten Ressourcen sowie ein Ablauf der
...
\tabelle{ProjektplanKurz}{tab:Projektplan}{ZeitplanKurz.tex}
...
\begin{itemize}
\item
	Im Projektantrag wurde festgelegt, dass bestimmte Bibliotheken mit Python für das Webscraping-System zusammen mit einem einfachen Codebeispiel verwendet werden.
	 ...
	 Die Menge der verwertbaren Stammdaten hat sich aufgrund der begrenzten Komplexität des Webscrapers reduziert.
	 Dies ist auf Probleme bei der manuellen Dateneingabe sowie auf http/https-Probleme zurückzuführen.
	 Stattdessen, werden nur korrekt formatierte Websites (auch nur solche, die das HTTPS verwenden) von der Anwendung eingelesen.
\end{itemize}
...
\begin{itemize}
	...
	Was ein inkrementelles Vorgehensmodell auszeichnet, ist, dass das zu entwickelnde System nicht im Voraus in allen Details genau geplant und dann in einem einzigen langen Durchgang entwickelt wird. 
